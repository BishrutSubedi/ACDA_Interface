...
if qOSM.get_backed() == "PyQt5":
    ...
    from PyQt5.QtWidgets import * #importing all the  names in module (only public) private import hunnna
...
##                # map.moveMarker("MyDragableMark", latitude, longitude)
        ...
        def local_callback(llocation):
            llat=llocation.latitude
            llon=llocation.longitude
        ...
        def remote_callback(rlocation):
            rlat=rlocation.latitude
            rlon=rlocation.longitude
            #move_mark(self,lat,lon)
        ...
        def optimize_channel_fun():
            os.system(
                "sudo /home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/src/tx2_directional_antenna_system/GetRSSI.sh") #BISHRUT updates file1 in folder file1 called later
            if self._LOS_NLOS == 1:
        ...
        def run_calibration_fun():
            ...
            if (self._LOS_NLOS == 1):
                ...
                # os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/stop_IMU_calibration.sh 1")
                # time.sleep(7)
                os.system( "/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/start_IMU_calibration.sh 1")
            else:
                # print("calibrate local IMU")
                # os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/stop_IMU_calibration.sh 0")
                # time.sleep(7)
                os.system( "/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/start_IMU_calibration.sh 0")
        ...
        def imu_run_stop_click():
            ...
            if self.imu_run_stop_value==1:
                ...
                time.sleep(1)
                self.imu_state_timer.start(60000)   #Bishrut what's happening here figure out
                imu_threading.start()               #Bishrut what's happening here figure out
        ...
        def stat_ros_nodes():
            print("stat ROS node ...")
            # os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/save_rosbag.sh")
            # if self._LOS_NLOS==1:



            if self.initial_heading==500:
                # os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/stop_ROS_nodes.sh %d" % (self._LOS_NLOS))
                # time.sleep(7)
                os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/start_ros_no_initial.sh %d " % (self._LOS_NLOS))

            else:
                # ros
                os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/start_ros_with_initial.sh %d %d" %(self._LOS_NLOS,self.initial_heading))

            # else:
            #     os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/start_local.sh %d %f" % self._LOS_NLOS,self.initial_heading)
        ...
        def run_camera_nodes():
            if self.camera_run_save_stop_state==1:
                ...
                if infrared_camera.isChecked():         #Bishrut what does this do ?
                    camera_comman=10
                ...
                os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/start_camera_nodes.sh %d %d" %(camera_comman,opt_camera_comman))
                ...
                os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/save_camera_nodes.sh %d %d" % (save_inf_var, save_opt_var))


            elif self.camera_run_save_stop_state==3:
                camera_run_button.setText("Confirm")
                self.camera_run_save_stop_state = 1
                os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/stop_camera_nodes.sh")




            # if optical_camera.isChecked() and infrared_camera.isChecked():
            #     os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/start_camera_nodes.sh 1 1")
            # elif optical_camera.isChecked() and infrared_camera.isChecked()==0:
            #     os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/start_camera_nodes.sh 1 0")
            # elif optical_camera.isChecked()==0 and infrared_camera.isChecked()==1:
            #     os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/start_camera_nodes.sh 0 1")
        ...
        def initial_scan_run():
            os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/start_initial_scan.sh")
        ...
        def calculate_Azimuth():
            if self._LOS_NLOS==1 and self.run_initial_scan==1:
                ...
                IMU_run_stop_button.setStyleSheet(
                    "background-color: rgb(245,128,38);padding: 6px; border-radius:5px;text_align:left")
                # os.system("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/shell/stop_initial_scan.sh")
            ...
            if self._LOS_NLOS==0:
                ...
                if r_coordsEdit.text() and r_coordsEdit.text().find(",") != -1:
                    ...
                    try:
                        ...
                        temp_remote_gps_msg.latitude= r_latitiude
                        temp_remote_gps_msg.longitude =r_longitude
                        print(temp_remote_gps_msg)
        ...
        temp_remote_gps = rospy.Publisher('temp_gps_location', NavSatFix, queue_size=1)
        temp_remote_gps_msg = NavSatFix()
        ...
        green_icon = QPixmap(("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/src/tx2_directional_antenna_system/greenenergy.png"))
        green_icon = green_icon.scaled(40, 40, Qt.KeepAspectRatio)

        red_icon = QPixmap(("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/src/tx2_directional_antenna_system/redenergy.png"))
        red_icon = red_icon.scaled(40, 40, Qt.KeepAspectRatio)


        ConnectionBar1 = QPixmap(("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/src/tx2_directional_antenna_system/ConnectionIndex1.png"))
        ConnectionBar2 = QPixmap(("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/src/tx2_directional_antenna_system/ConnectionIndex2.png"))
        ConnectionBar3 = QPixmap(("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/src/tx2_directional_antenna_system/ConnectionIndex3.png"))
        ConnectionBar4 = QPixmap(("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/src/tx2_directional_antenna_system/ConnectionIndex4.png"))
        ConnectionBar5 = QPixmap(("/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/src/tx2_directional_antenna_system/ConnectionIndex5.png"))
        ...
        self.map.addMarker("local GPS", *coords, **dict(
            icon="file:///home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/src/tx2_directional_antenna_system/local_uav.png",
            draggable=True,
        ...
        self.map.addMarker("remote GPS", *coords, **dict(
            ...
            icon= "file:///home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/src/tx2_directional_antenna_system/remote_uav.png",
            draggable=True,
            title="remote GPS marker"
        ))
	sub1 = rospy.Subscriber("/local_gps", NavSatFix, local_callback)
        sub2 = rospy.Subscriber("/remote_gps", NavSatFix, remote_callback)
        sub3=rospy.Subscriber("/local_rssi",Int8,l_rssi_callback)
        sub4=rospy.Subscriber("/remote_rssi",Int8,r_rssi_callback)
...
class conn_Test(QThread):
    ...
    def nanotest(self):
        return testconn('192.168.1.110',80)
    def remote_BBB_conn(self):
        return testconn('192.168.1.130',22)
    def local_BBB_conn(self):
        return testconn('192.168.1.131',22)
    def rapi_conn(self):
        return testconn('192.168.1.130',22)
    def optical_conn(self):
        return testconn('192.168.1.130',80)

...
def local_change_channel(*args):
	...
	file_channelno = open('/home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/src/tx2_directional_antenna_system/file_channelno_local.txt','w')
	...
	browser1.get("http://192.168.1.111")
	...
	browser1.get("http://192.168.1.111/html/content1.asp")

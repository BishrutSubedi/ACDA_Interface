...
sudo iwlist wlp2s0 scan |egrep -i Frequency\|Quality > /home/dnc2/Documents/catkin_ws/src/tx2_directional_antenna_system/src/tx2_directional_antenna_system/file1.txt
#sleep 3
